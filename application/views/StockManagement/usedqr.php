                        ...
                        <table id="tableData" class="table table-bordered smallfonttable">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 150px;">Plumber</th>
                                    <th style="width: 150px;">Points</th>
                                    <th style="width: 150px;">Scan Date/Time</th>
                                ...
                                if (count($prouctlist)) {
                                    ...
                                    foreach ($prouctlist as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $value["name"]; ?><br/><?php echo $value["contact_no"]; ?></td>
                                            <td><?php echo $value["points"]; ?></td>
                                            <td><?php echo $value["date"]; ?><br/><?php echo $value["time"]; ?></td>

                                            <td>
                                                <a href="<?php echo site_url('AppUser/user_details/' . $value["user_id"]); ?>" class="btn btn-danger"><i class="fa fa-eye "></i> View</a>
                                            </td>
                                        </tr>
                                        <?php
                                        $count++;
